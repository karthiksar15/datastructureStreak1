public class May29264 {

    public static void main(String[] args) {
        int[] nums1 = { 1, 2 };
        int[] nums2 = { 3 };
        May29264 may = new May29264();
        System.out.println("median-->" + may.findMedianSortedArrays(nums1, nums2));
    }
    ...
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        while (l <= r) {
            ...
            if (aleft <= bright && bleft <= bright) {
                ...
                return (Math.max(aleft, bleft) + Math.max(aright, bright)) / 2;
